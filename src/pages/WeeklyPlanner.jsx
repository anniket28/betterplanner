...
export default function WeeklyPlanner(props) {
  ...
  const [tasks, setTasks] = useLocalStorageWithReset("weeklyTasks", "weekly");
  ...
  const completedCount = tasksForDay.filter(t => t.done).length;
  ...
  return (
    <div className="p-6 bg-gray-50 min-h-screen">
      ...
      {/* Day Selector with Task Count for All Days */}
